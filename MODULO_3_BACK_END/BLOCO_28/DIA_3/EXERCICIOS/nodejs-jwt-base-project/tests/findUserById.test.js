...
describe("GET /api/users/:userId", () => {
  ...
  describe("Quando o usuário autenticado e solicitando os dados próprios", () => {
    let response;
    const DBServer = new MongoMemoryServer();
    ...
    it('objeto de resposta possui a propriedade "_id"', () => {
      expect(response.body).to.have.property("_id", EXAMPLE_ID);
    });
    
    it('objeto de resposta possui a propriedade "username"', () => {
      expect(response.body).to.have.property("username", "fake-user");
    });
  
    it('objeto de resposta possui a propriedade "password"', () => {
      expect(response.body).to.have.property("password", "fake-password");
    });
  });
});
