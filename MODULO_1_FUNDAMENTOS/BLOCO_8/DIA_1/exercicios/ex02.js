...
const verifyBeat = (beat) => beat === Math.floor(Math.random() * 5 + 1);

const winner = (beat, verify) =>
  verify(beat) ? "Parabéns você ganhou!" : "Tente novamente";

console.log(winner(1, verifyBeat));
