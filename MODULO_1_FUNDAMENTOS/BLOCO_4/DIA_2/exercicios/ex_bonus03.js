...
// pois é a multiplicação de 5(primeiro valor) e 9(valor seguinte).Já o segundo valor do
// novo array deverá ser 27, pois é a multiplicação de 9(segundo valor) e 3(valor seguinte), e assim
// por diante.Caso não haja próximo valor, a multiplicação deverá ser feita por 2. Faça isso utilizando
